...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # نمایش در کنسول
EMAIL_HOST = 'localhost'
EMAIL_PORT = 1025
# برای تولید واقعی، باید این تنظیمات رو بذاری:
# تنظیمات ایمیل
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'  # یا هر سرویس دیگه
EMAIL_PORT = 587
EMAIL_USE_TLS = True
